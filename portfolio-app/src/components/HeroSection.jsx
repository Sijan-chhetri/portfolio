      ...
      <div className="container mx-auto px-4 z-10 grid grid-cols-1 items-center relative h-full">
          ...
          <div className="relative w-full max-w-4xl opacity-0 animate-[fadeInUp_1.5s_ease-out_forwards]">
            <div className="relative portrait-glow flex justify-center">
              <img
                ...
                className="h-[85vh] w-auto object-contain opacity-90 dark:mix-blend-luminosity grayscale contrast-125 hover:grayscale-0 transition-all duration-1000"
                src={profileImg}
              />
        ...
        <div className="flex flex-col items-center justify-center text-center space-y-8 mt-20">
          <div className="space-y-4 opacity-0 animate-[fadeInUp_1s_ease-out_0.5s_forwards]">
            <span className="uppercase font-serif text-xs letter-spacing-widest block mb-4 text-[#0f172a] dark:text-primary font-semibold tracking-widest">
              Full-Stack Software Engineer
            </span>
            <h1 className="text-5xl md:text-8xl font-display italic tracking-tight text-[#0f172a] dark:text-[#f8f5f0] drop-shadow-[0_2px_8px_rgba(248,245,240,0.8)] dark:drop-shadow-none">
              Sijan Katuwal Chhetri
            </h1>
            <p className="text-sm md:text-lg font-light tracking-[0.4em] uppercase text-[#0f172a]/70 dark:text-slate-400 drop-shadow-[0_1px_4px_rgba(248,245,240,0.9)] dark:drop-shadow-none">
          ...
          <div className="max-w-xl mx-auto opacity-0 animate-[fadeInUp_1s_ease-out_0.8s_forwards]">
            <p className="text-[#0f172a]/80 dark:text-slate-400 leading-relaxed font-light text-sm md:text-base px-6 drop-shadow-[0_1px_4px_rgba(248,245,240,0.9)] dark:drop-shadow-none">
          ...
          <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-8 pt-8 opacity-0 animate-[fadeInUp_1s_ease-out_1.1s_forwards]">
            <a
              href="#projects"
              className="group relative px-10 py-4 bg-[#0f172a] dark:bg-primary text-white dark:text-background-dark font-serif uppercase text-xs tracking-widest overflow-hidden transition-all duration-300 hover:shadow-[0_0_30px_rgba(15,23,42,0.3)] dark:hover:shadow-[0_0_30px_rgba(201,162,39,0.3)]"
            >
            ...
            <a
              href="#contact"
              className="px-10 py-4 border-2 border-[#0f172a] text-[#0f172a] dark:border-primary/70 dark:text-primary font-serif uppercase text-xs tracking-widest hover:bg-[#0f172a]/10 dark:hover:bg-primary/10 transition-all duration-300 bg-[#f8f5f0]/50 dark:bg-transparent backdrop-blur-sm"
            >
              Hire Me
            </a>
            <a
              ...
              className="px-10 py-4 border-2 border-[#0f172a] text-[#0f172a] dark:border-primary dark:text-primary font-serif uppercase text-xs tracking-widest hover:bg-[#0f172a] hover:text-[#f8f5f0] dark:hover:bg-primary dark:hover:text-background-dark transition-all duration-300 flex items-center gap-2 bg-[#f8f5f0]/50 dark:bg-transparent backdrop-blur-sm"
            >
      ...
      <div className="hidden lg:block absolute left-12 top-1/2 -translate-y-1/2 z-20">
        <div className="flex flex-col space-y-24 items-center">
          {["Python", "Django", "React"].map((w) => (
            <span key={w} className="text-[10px] uppercase tracking-[1em] text-[#0f172a] dark:text-[#f8f5f0]/50 -rotate-90 font-semibold">
              {w}
            </span>
          ))}
        </div>
      ...
      <div className="hidden lg:block absolute right-12 top-1/2 -translate-y-1/2 z-20">
        <div className="flex flex-col space-y-8 items-center">
          <a href={SOCIAL_LINKS.instagram} target="_blank" rel="noreferrer"
            className="text-[#0f172a]/40 dark:text-primary/40 hover:text-[#0f172a] dark:hover:text-primary hover:scale-125 transition-all duration-300" aria-label="Instagram">
          ...
          <a href={SOCIAL_LINKS.github} target="_blank" rel="noreferrer"
            className="text-[#0f172a]/40 dark:text-primary/40 hover:text-[#0f172a] dark:hover:text-primary hover:scale-125 transition-all duration-300" aria-label="GitHub">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a href={SOCIAL_LINKS.linkedin} target="_blank" rel="noreferrer"
            className="text-[#0f172a]/40 dark:text-primary/40 hover:text-[#0f172a] dark:hover:text-primary hover:scale-125 transition-all duration-300" aria-label="LinkedIn">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
              <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
            </svg>
          </a>
          <a href="#contact"
            className="text-[#0f172a]/40 dark:text-primary/40 hover:text-[#0f172a] dark:hover:text-primary hover:scale-125 transition-all duration-300" aria-label="Email">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
