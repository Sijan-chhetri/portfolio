...
export default function Footer() {
  return (
    <footer className="py-12 px-8 border-t border-[#0f172a]/10 dark:border-primary/10 bg-background-light dark:bg-background-dark">
        ...
        <div className="flex items-center gap-6">
          {socials.map(({ label, href, icon }) => (
            <a
              ...
              rel="noreferrer"
              aria-label={label}
              className="text-[#0f172a]/40 dark:text-primary/40 hover:text-[#0f172a] dark:hover:text-primary hover:scale-125 transition-all duration-300"
            >
              {icon}
            </a>
          ))}
